...
class SMWalletTopPNLTokenHandler(BaseSQLiteHandler):
    """
    ...
    def insertSMWalletToken(self, token_data: SMWalletTopPnlToken, cursor: Optional[sqlite3.Cursor] = None) -> bool:
        """
    ...
    def updateSMWalletToken(self, token_data: SMWalletTopPnlToken, cursor: Optional[sqlite3.Cursor] = None) -> bool:
        """
    ...
    def updateSMWalletTokenInvestmentData(self, token_data: SMWalletTopPnlToken, cursor: Optional[sqlite3.Cursor] = None) -> bool:
        """
    ...
    def convertRowToObject(self, row: sqlite3.Row) -> Optional[SMWalletTopPnlToken]:
        """
        ...
        try:
            with self.conn_manager.transaction() as cursor:
                cursor.execute("""
                    ...
                    WHERE walletaddress = ? 
                    AND tokenid = ?
                """, (transactionsCount,datetime.now(), walletAddress, tokenId))
